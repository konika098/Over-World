...
<p className="text-2xl mt-10 italic font-bold">with Season 1 Ending with our play and duis element sollicitudin is yaugue euismods Nulla ulla player-focused updates games from Mobile app and Enjoy</p>
 ...
 <img data-aos="fade-down" data-aos-easing="linear"
     data-aos-duration="1500" className="mx-auto mt-9" src="/public/asstes/roadmap.png" alt="" />
 <Link to="/contact" className="btn bg-purple-800 mt-5 text-white">roadmap</Link>
</div>
