                    ...
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <div className="flex flex-wrap -m-2">
                            <form onSubmit={handleRegister} className="flex flex-wrap -m-2">
                                ...
                                <div className="p-2 w-full">
                                    <button onClick={handleGoogle} className="flex mx-auto text-white bg-purple-700 border-0 py-2 px-8 focus:outline-none hover:bg-purple-700 rounded text-lg">Register in with Google</button>
